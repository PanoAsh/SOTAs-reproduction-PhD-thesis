...
parser.add_argument('--max_epoch', type=int, default=40, help='Number of epochs for training')
...
def train():
    ...
    for epoch in range(args.resume_epoch, args.max_epoch):
        ...
        if args.test_interval >= 0 and epoch % args.test_interval == (args.test_interval - 1):
            ...
            model.test(epoch, _save=True) #(epoch > (args.pretrain_epoch-args.test_interval)))
