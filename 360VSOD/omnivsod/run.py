...
if __name__ == '__main__':
    ...
    parser.add_argument('--benchmark_model', type=bool, default=True)  # should be false during train/test our model
    ...
    parser.add_argument('--lr', type=float, default=1e-11)  # 1/10 of default Lr for benchmark models
    ...
    parser.add_argument('--model_type', type=str, default='G')  # L for TI-based trainig/testing; EC for our model
