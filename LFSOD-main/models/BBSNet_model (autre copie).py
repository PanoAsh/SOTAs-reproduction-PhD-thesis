...
class RefineSalMap(nn.Module):
    def __init__(self):
        ...
        self.refine_1 = nn.Sequential(
                        nn.Conv2d(13, 32, kernel_size=3, stride=1, padding=1, bias=False),
                        nn.BatchNorm2d(32),
        ...
        self.bilinear_1 = nn.UpsamplingBilinear2d(size=(176, 176))
        self.bilinear_2 = nn.UpsamplingBilinear2d(size=(352, 352))
...
class BBSNet(nn.Module):
    def __init__(self, channel=32):
        ...
        #Refinement flow
        self.HA = Refine()
        self.FS_fusion = RefineSalMap()
        self.downsample4 = nn.Conv2d(1, 1, kernel_size=1, stride=8, bias=True)
    ...
    def forward(self, x, x_depth, x_fss):
      ...
      #  x, x1, x5 = self.HA(attention_map.sigmoid(), x, x1, x2)
        ...
        return self.upsample(attention_map), y, attention_map_fusion
