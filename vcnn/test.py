...
def main(log_dir, batch_size, num_workers, flownet_ckpt, test_start_frame, test_interval):
    ...
    if torch.cuda.device_count() > 1:
        device_alignment = torch.device('cuda:0')
    else:
...
if __name__ == "__main__":
    ...
    parser.add_argument('--log_dir', type=str, default=os.getcwd() + '/log')
    parser.add_argument('--flownet_ckpt', type=str, default=os.getcwd() + '/pretrained_models/FlowNet2_checkpoint.pth.tar')
