...
pretrained_model = os.getcwd() + '/pretrained/pretrained_model.pt'

def train(Dataset, Network):
    ## dataset
    cfg    = Dataset.Config(datapath=DATA_PATH, savepath=SAVE_PATH, mode='train', batch=1, lr=0.005, momen=0.9, decay=5e-4, epoch=100)
    data   = Dataset.Data(cfg)
    loader = DataLoader(data, batch_size=cfg.batch, shuffle=True, num_workers=1)
